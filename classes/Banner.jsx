...
import { getApproved, getData, uploadPic } from "./functions.jsx";
        ...
        return <div>
            <div className="w3-card-4 w3-panel w3-cyan">
                <header className="w3-bar w3-cyan">
                    <h3 className="w3-bar-item">Hello <b>{this.state.user}</b>!</h3>
            ...
            <button onClick={() =>  getData(this.state.client)}>Get Unapproved Pictures</button>
